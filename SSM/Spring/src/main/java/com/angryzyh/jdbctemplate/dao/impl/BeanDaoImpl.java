...
public class BeanDaoImpl implements BeanDao {
    ...
    public int addBean(Bean bean) {
        String sql = "insert into ssm_spring_bean values(null,?)";
    ...
    public int updateBean(Bean bean) {
        String sql = "update ssm_spring_bean set bean_name=? where bean_id=?";
    ...
    public int deleteBean(Bean bean) {
        String sql = "delete from ssm_spring_bean where bean_id=?";
